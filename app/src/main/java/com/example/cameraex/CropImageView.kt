...
class CropImageView {
    class CropImageView : AppCompatImageView {
        ...
        val croppedImage: Bitmap?
            get() {
                ...
                val cropWidth = Math.min(Edge.width / scaleX, originalBitmap.width - cropX)
                val cropHeight = Math.min(Edge.height / scaleY, originalBitmap.height - cropY)
        ...
        private val targetAspectRatio: Float
            private get() = mAspectRatioX / mAspectRatioY.toFloat()
    ...
    enum class Handle(private val mHelper: HandleHelper) {
        ...
        BOTTOM_LEFT(CornerHandleHelper(Edge.BOTTOM, Edge.LEFT)), BOTTOM_RIGHT(
            CornerHandleHelper(
                Edge.BOTTOM,
                Edge.RIGHT
            )
        ),
        LEFT(VerticalHandleHelper(Edge.LEFT)), TOP(HorizontalHandleHelper(Edge.TOP)), RIGHT(
            VerticalHandleHelper(Edge.RIGHT)
        ),
        BOTTOM(HorizontalHandleHelper(Edge.BOTTOM)), CENTER(CenterHandleHelper());
    ...
    internal class VerticalHandleHelper(private val mEdge: Edge) : HandleHelper(
        null,
        mEdge
    ) {
